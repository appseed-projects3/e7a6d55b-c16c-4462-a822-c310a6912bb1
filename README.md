...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-21 22:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e7a6d55b-c16c-4462-a822-c310a6912bb1.git
$ cd e7a6d55b-c16c-4462-a822-c310a6912bb1
```
